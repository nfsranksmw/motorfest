// Lista estática manual con todos los vehículos actualizados y los anteriores integrados como viables
const metaVehiclesData = [
    // --- STREET TIER 1 ---
    { category: "Street Tier 1", brand: "Mazda", model: "MX-5 Miata NA", metaStatus: "meta" },
    { category: "Street Tier 1", brand: "Fiat", model: "500 F", metaStatus: "meta" },
    { category: "Street Tier 1", brand: "Lancia", model: "Delta HF Integrale", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Porsche", model: "911 Carrera RS 2.7", metaStatus: "contenders" },
    { category: "Street Tier 1", brand: "Audi", model: "RS 2 Avant", metaStatus: "contenders" },
    { category: "Street Tier 1", brand: "Ford", model: "Mustang Mach-E GT (-10% relación final)", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Audi", model: "RS 3 Sportback", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "BMW", model: "M3 Sport Evolution / ErlKönig Ed.", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Ford", model: "Focus RS", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Lancia", model: "Stratos HF Stradale", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Land Rover", model: "Defender 110 V8", metaStatus: "viable" },
    { category: "Street Tier 1", brand: "Mazda", model: "Rx-7 Turbo 10th Anniversary", metaStatus: "viable" },

    // --- STREET TIER 2 ---
    { category: "Street Tier 2", brand: "Alpine", model: "A110 R Ultimate", metaStatus: "meta" },
    { category: "Street Tier 2", brand: "Ferrari", model: "F50", metaStatus: "meta" },
    { category: "Street Tier 2", brand: "Ferrari", model: "GTO", metaStatus: "meta" },
    { category: "Street Tier 2", brand: "Ferrari", model: "F40", metaStatus: "contenders" },
    { category: "Street Tier 2", brand: "Porsche", model: "911 GT (993)", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Porsche", model: "911 GT3 RS (2023)", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Lamborghini", model: "Huracán LP610-4", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Ferrari", model: "F40 / F50 (Anterior)", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Mazda", model: "Rx-7 Red Fury Ed. (Summit)", metaStatus: "viable" },
    ...
    { category: "Street Tier 2", brand: "Aston Martin", model: "V8 Vantage S", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Audi", model: "RS5 Coupé / USST Official Ed.", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "BMW", model: "M5 CS / Rival Ed.", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Chevrolet", model: "Corvette ZR1", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Dodge", model: "Challenger SRT Demon Awaken Ed. / Charger SRT Hellcat Redeye Widebody", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Ferrari", model: "512 TR (Testarossa)", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Honda", model: "NSX", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Hoonigan", model: "Audi Scotto's Coupé quattro", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Lotus", model: "Exige S", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Mercedes-AMG", model: "SLS", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Nissan", model: "R32 / R34 Blackphanthaa Ed. (Summit)", metaStatus: "viable" },
    { category: "Street Tier 2", brand: "Porsche", model: "911 GT3 RS", metaStatus: "viable" },

    // --- DRIFT ---
    { category: "Drift", brand: "Hoonigan", model: "Ford Hoonicorn Mustang", metaStatus: "meta" },
    { category: "Drift", brand: "Hoonigan", model: "Mitsubishi Lancer Evo IX", metaStatus: "viable" },
    { category: "Drift", brand: "Hoonigan", model: "Audi S1 e-tron quattro", metaStatus: "viable" },

    // --- ALPHA GP ---
    { category: "Alpha GP", brand: "Red Bull", model: "RB14 Disruption Ed. (El mejor - Balance)", metaStatus: "meta" },
    { category: "Alpha GP", brand: "Red Bull", model: "RB14 (Balanceado)", metaStatus: "viable" },
    ...
    { category: "Alpha GP", brand: "Ivory Tower", model: "IVT AGP R-07", metaStatus: "viable" },
    { category: "Alpha GP", brand: "Proto", model: "Alpha Mark II", metaStatus: "viable" },
    { category: "Alpha GP", brand: "Red Bull", model: "RB18", metaStatus: "viable" },

    // --- RACING ---
    { category: "Racing", brand: "Chevrolet", model: "Camaro SS 2010 Edición Racing", metaStatus: "meta" },
    { category: "Racing", brand: "Gordon Murray Automotive", model: "T.50s 2024", metaStatus: "meta" },
    { category: "Racing", brand: "Ferrari", model: "F40 LM", metaStatus: "contenders" },
    { category: "Racing", brand: "Volkswagen", model: "Electric R", metaStatus: "viable" },
    { category: "Racing", brand: "BMW", model: "M Hybrid V8 No.15", metaStatus: "contenders" },
    ...
    { category: "Racing", brand: "Ferrari", model: "FXX K / 599XX EVO", metaStatus: "viable" },
    { category: "Racing", brand: "KTM", model: "X-Bow GT2", metaStatus: "viable" },
    { category: "Racing", brand: "Radical", model: "RXC 600 R", metaStatus: "viable" },

    // --- DRAGSTER ---
    { category: "Dragster", brand: "Proto", model: "Hup One Burning Wheels (Trampas de velocidad)", metaStatus: "meta" },
    { category: "Dragster", brand: "Dodge", model: "SRT Viper GTS 2013 (Eventos de Drag)", metaStatus: "viable" },

    // --- HYPERCAR ---
    { category: "Hypercar", brand: "Hennessey", model: "Venom F5", metaStatus: "meta" },
    { category: "Hypercar", brand: "W Motors", model: "Fenyr Supersport 2021", metaStatus: "meta" },
    { category: "Hypercar", brand: "Pagani", model: "Imola 2021", metaStatus: "meta" },
    { category: "Hypercar", brand: "Gordon Murray Automotive", model: "T.50", metaStatus: "meta" },
    { category: "Hypercar", brand: "Noble", model: "M600 Lunar Edicion Year", metaStatus: "contenders" },
    { category: "Hypercar", brand: "Lamborghini", model: "Fenómeno", metaStatus: "viable" },
    { category: "Hypercar", brand: "Touring Superleggera", model: "Arese RH95", metaStatus: "contenders" },
    { category: "Hypercar", brand: "Ferrari", model: "F88 Pista", metaStatus: "contenders" },
    { category: "Hypercar", brand: "Noble", model: "M500", metaStatus: "viable" },
    { category: "Hypercar", brand: "Koenigsegg", model: "Agera R (Mejor)", metaStatus: "viable" },
    { category: "Hypercar", brand: "Rimac", model: "Nevera T.A. Ed. (Smt) - Aceleración", metaStatus: "viable" },
    { category: "Hypercar", brand: "Bugatti", model: "Centodieci", metaStatus: "viable" },
    { category: "Hypercar", brand: "Ferrari", model: "Enzo Ferrari", metaStatus: "viable" },
    { category: "Hypercar", brand: "Ferrari", model: "488 Pista", metaStatus: "viable" },
    { category: "Hypercar", brand: "Koenigsegg", model: "Jesko", metaStatus: "viable" },
    { category: "Hypercar", brand: "Lamborghini", model: "Revuelto", metaStatus: "viable" },
    { category: "Hypercar", brand: "Lamborghini", model: "Aventador LP700-4", metaStatus: "viable" },
    { category: "Hypercar", brand: "Mercedes-AMG", model: "One", metaStatus: "viable" },
    { category: "Hypercar", brand: "McLaren", model: "Senna", metaStatus: "viable" },
    { category: "Hypercar", brand: "Porsche", model: "Carrera GT", metaStatus: "viable" },
    { category: "Hypercar", brand: "Porsche", model: "911 GT1 Strassenversion (993)", metaStatus: "viable" },
    { category: "Hypercar", brand: "Porsche", model: "919 Street", metaStatus: "viable" },
    { category: "Hypercar", brand: "W Motors", model: "Lykan Hypersport", metaStatus: "viable" },

    // --- RALLY RAID ---
    { category: "Rally Raid", brand: "BMW", model: "Z4 sDrive35is (Mejor)", metaStatus: "meta" },
    { category: "Rally Raid", brand: "Porsche", model: "959 Raid (Balanceado)", metaStatus: "viable" },
    ...
    { category: "Rally Raid", brand: "Ariel", model: "Nomad", metaStatus: "viable" },
    { category: "Rally Raid", brand: "Hummer", model: "H1 Alpha Evo 1", metaStatus: "viable" },
    { category: "Rally Raid", brand: "Jeep", model: "Wrangler Evo 2", metaStatus: "viable" },
    { category: "Rally Raid", brand: "Nissan", model: "Skyline GT-R (R34)", metaStatus: "viable" },
    ...
    // --- RALLY ---
    { category: "Rally", brand: "Mini", model: "Cooper S Countryman All4", metaStatus: "meta" },
    { category: "Rally", brand: "Ivory Tower", model: "Ogmios Rally1 Spec", metaStatus: "meta" },
    { category: "Rally", brand: "Ford", model: "Puma Hybrid Rally", metaStatus: "contenders" },
    { category: "Rally", brand: "Peugeot", model: "T16 Evo 2", metaStatus: "contenders" },
    { category: "Rally", brand: "Peugeot", model: "205 T16 Evo 2 (Original)", metaStatus: "viable" },
    ...
    { category: "Rally", brand: "Citroën", model: "C3 Racing", metaStatus: "viable" },
    { category: "Rally", brand: "Lancia", model: "Delta S4", metaStatus: "viable" },
    { category: "Rally", brand: "Nissan", model: "Skyline GT-R (R34)", metaStatus: "viable" },
    { category: "Rally", brand: "Renault", model: "Maxi 5 Turbo", metaStatus: "viable" },
    ...
    { category: "Powerboat", brand: "ICE Marine", model: "BladeRunner 35 (Destrozo de boyas)", metaStatus: "viable" },
...
function renderizarVehiculosDeCategoria(categoryName, filtroBusqueda = "", filtroStatus = "all") {
    ...
    vehiculosFiltrados.forEach(vehiculo => {
        ...
        if (status === "meta") {
            ...
            badgeHtml = `<span style="background: rgba(59, 130, 246, 0.15); color: #3b82f6; border: 1px solid #3b82f6; font-size: 10px; padding: 2px 8px; border-radius: 4px; font-family: 'Orbitron', sans-serif;">BALANCED / CONTENDER</span>`;
